---
title: The HTML
description: Every website we visit the actual backbone is HTML, The core of every website.
...
<Callout title="Note">
  The above lines of code are commonly known as **BOILERPLATE**. <br /> We can
  write it with the help of the emmet abbreviation- `! + enter` | `html5 +
  enter`
</Callout>
...
`<head>` contains meta-information about the HTML document itself. <br />
`<meta>` metadata about the HTML document, such as character set, viewport settings, and description. <br />
