...
![git-control](/the-git-universe/git-control.png)
...
![alt text](/the-git-universe/git-track-process.png)
...
<Callout title="Note">`-m` flag is used to add commit message</Callout>
...
![code flow](/the-git-universe/code-flow.png)
...
![only main](/the-git-universe/only-main.png)
...
![conflict with single branch](/the-git-universe/conflict-1.png)
...
![confusion](/the-git-universe/confusion.png)
...
`-u` flag is used change the upstream so that next time when you push the code from `new-feature` branch <br />
...
Will push changes on remote but does not change upstream. <br />
...
![branch flow](/the-git-universe/git-branch-flow.png)
...
Once your branch is merged to `main` <br />
...
![git merged](/the-git-universe/git-merged.png)
